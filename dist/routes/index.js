...
const express_1 = require("express"); // importação do 'router'
const PageController = __importStar(require("../controllers/pageController")); // importando 'controller' pageController
